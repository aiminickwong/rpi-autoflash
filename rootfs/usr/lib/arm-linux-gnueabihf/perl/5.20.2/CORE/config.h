...
/* Package name      : perl5
 * Source directory  : .
 * Configuration time: Mon Jun  5 12:18:37 UTC 2017
 * Configured by     : Debian Project
 * Target system     : linux bm-wb-01 4.9.0-0.bpo.1-armmp #1 smp debian 4.9.2-2~bpo8+1 (2017-01-26) armv7l gnulinux 
 */
 ...
 */
#define OSNAME "linux"		/**/
#define OSVERS "4.9.0-0.bpo.1-armmp"		/**/
